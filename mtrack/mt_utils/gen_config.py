...
config.set('Output', 'save_connected', 'True')
config.set('Output', 'save_core_graphs', 'True')
...
config.set('Cluster', 'cluster', True)
config.set('Cluster', 'cluster_output_dir', './cluster')
config.set('Cluster', 'epsilon_lines', 150)
config.set('Cluster', 'epsilon_volumes', 100)
config.set('Cluster', 'min_overlap_volumes', 1)
config.set('Cluster', 'cluster_orientation_factor', 1000)
config.set('Cluster', 'remove_singletons', 3)
config.set('Cluster', 'use_ori', True)
