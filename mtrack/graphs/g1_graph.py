...
class G1(G):
    ...
    def get_components(self, 
        ...
        len_masks = len(masks)
        for mask in masks:
            logger.info("Filter graph " + str(n) + "/" + str(len_masks)) 
            if output_folder is not None:
